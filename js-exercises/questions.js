...
const k = numRotations % array.length;
...
function describePerson(person) {
  ...
  if (hobby) {
    return `${name} is a ${age}-year-old ${genderWord}. ${pronoun} likes ${hobby}!`;
  } else {
    return `${name} is a ${age}-year-old ${genderWord}. ${pronoun} has no hobbies.`;
  }
}
